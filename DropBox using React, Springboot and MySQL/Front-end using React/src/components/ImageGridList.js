        ...
        return (
            <div className={classes.root}>
                {this.props.images.map(tile => (
                    <div key={tile.img} cols={tile.cols || 1} style={{
                        textAlign: 'left',
                        paddingBottom: 25
                    }}>
                        <div className='col-md-10'>
                            <a href={'http://localhost:3001/uploads/' + tile.img} alt={'myimage'}
                               style={{color: 'Black'}}> {tile.img} </a>
                            <a href='#'><span style={{paddingLeft: 20}} className={this.state.className}
                                        ...
                                        <div className="modal-body">
                                            <form role="form">
                                                <div className="form-group">
                                                    <input type="text" className="form-control" id="folder"
                                                           placeholder="folder name"/>
                                                </div>
                                            </form>
                                        </div>
                                        <div className="modal-footer">
                                            <button type="submit" className="btn btn-primary btn-default pull-left"
                                                    data-dismiss="modal">create folder
                                            </button>
                                        </div>
                                    </div>
